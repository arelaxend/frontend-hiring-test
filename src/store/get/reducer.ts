...
import { Call, GetActions, GetState, SetCallAction, SetFiltersAction, SetOffsetsAction } from "./types";

export const initialFilters = ["archived", "missed", "voicemail", "inbound", "outbound"];
